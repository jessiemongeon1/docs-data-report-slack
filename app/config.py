...
class Settings:
    ...
    def from_env() -> "Settings":
        sites_json = os.environ.get(
            "SITES_JSON",
            '[{"name":"docs.sui.io","plausible_site_id":"docs.sui.io","kapa_project_id":"docs"},'
            '{"name":"docs.wal.app","plausible_site_id":"docs.wal.app","kapa_project_id":"docs"}]',
        )
